...
@section('title')
    <title>TI Poliwangi | Update Berita</title>
@endsection
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-theme" id="judul_berita"
                                        ...
                                        value="{{ isset($berita) ? $berita->judul_berita : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-theme" id="penyelenggara_berita"
                                        ...
                                        value="{{ isset($berita) ? $berita->penyelenggara_berita : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="date-input" type="date" data-dd-opt-custom-class="dd-theme-bootstrap"
                                        ...
                                        value="{{ isset($berita) ? $berita->tanggal_berita : '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="row ml-4 mr-4">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-theme" id="kategori_berita" name="kategori_berita">
                                            ...
                                            {{-- loop kategori from kategori table --}}
                                            @foreach ($kategori as $itemKategori)
                                                <option value="{{ $itemKategori->id }}"
                                                    {{ $itemKategori->id == $itemKategori->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-theme" id="status_berita" name="status_berita">
                                            ...
                                            <option value="Aktif"
                                                {{ $berita->status_berita == 'Aktif' ? 'selected' : '' }}>
                                                Aktif</option>
                                            <option value="Non Aktif"
                                                {{ $berita->status_berita == 'Selesai' ? 'selected' : '' }}>Non Aktif
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-color" id="desc_berita" name="desc_berita" placeholder="Rincian berita"
                                        rows="4">{{ isset($berita) ? $berita->desc_berita : '' }}</textarea>
                                </div>
                            </div>
                        </div>
