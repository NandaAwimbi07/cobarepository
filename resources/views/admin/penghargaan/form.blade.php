...
@section('title')
    <title>TI Poliwangi | Update Penghargaan</title>
@endsection

@section('heading', 'Update Data Baru Penghargaan')

@section('page')
    <li class="breadcrumb-item active">Update Penghargaan</li>
@endsection

@section('content')
    {{-- Start Container Form --}}
    <section class="bg-section pt-4 pb-5">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-theme" id="nama_prestasi"
                                        ...
                                        value="{{ isset($prestasi) ? $prestasi->nama_prestasi : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-theme" id="peraih_prestasi"
                                        ...
                                        value="{{ isset($prestasi) ? $prestasi->peraih_prestasi : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="date-input" type="date" data-dd-opt-custom-class="dd-theme-bootstrap"
                                        ...
                                        value="{{ isset($prestasi) ? $prestasi->tahun_prestasi : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-color" id="desc_prestasi" name="desc_prestasi" placeholder="Deskripsi prestasi"
                                        rows="3">{{ isset($prestasi) ? $prestasi->desc_prestasi : '' }}</textarea>
                                </div>
                            </div>
                        </div>
