...
@section('page')
    <li class="breadcrumb-item active">Dosen $ Staff Teknik Informatika </li>
@endsection
                                ...
                                <tbody>
                                    @foreach ($staff as $data)
                                        <tr>
                                            ...
                                            <td> <img src="{{ asset(Auth::user()->picture) }}" width="80px"
                                                    class="img-thumbnail">
                                            <td>{{ $data->nama_staff }}</td>
                                            <td>{{ $data->jabatan }}</td>
                                            </td>
                                            <td>
                                                <form action="{{ route('staff.destroy', $data->id_staff) }}" method="post">
                                                    @csrf
                                                    @method('delete')
