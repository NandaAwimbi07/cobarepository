                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-theme" id="jenis_file" name="jenis_file">
                                            ...
                                            <option value="SK Mahasiswa Aktif">SK Mahasiswa Aktif</option>
                                            <option value="Kalender Akademik">Kalender Akademik</option>
                                            <option value="Akreditasi Prodi TRPL">Akreditasi Prodi TRPL</option>
                                            <option value="Akreditasi Prodi TRK">Akreditasi Prodi TRK</option>
                                            <option value="Akreditasi Prodi BD">Akreditasi Prodi BD</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
