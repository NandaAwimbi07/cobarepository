...
@section('title')
    <title>TI Poliwangi | Update Kerjasama</title>
@endsection

@section('heading', 'Update Data Baru Kerjasama')

@section('page')
    <li class="breadcrumb-item active">Update Kerjasama</li>
@endsection

@section('content')
    {{-- Start Container Form --}}
    <section class="mt-2 pb-5 bg-section">
        <div class="row justify-content-center pb-t pt-5 mb-5">
            <div class="col-md-11">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-theme" id="nama_program"
                                        ...
                                        value="{{ isset($kerjasama) ? $kerjasama->nama_program : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-theme" id="nama_mitra" name="nama_mitra"
                                        ...
                                        value="{{ isset($kerjasama) ? $kerjasama->nama_mitra : '' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="date-input" type="date" data-dd-opt-custom-class="dd-theme-bootstrap"
                                        ...
                                        value="{{ isset($kerjasama) ? $kerjasama->tahun_kerjasama : '' }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control form-color" id="desc_kerjasama" name="desc_kerjasama" placeholder="Deskripsi prestasi"
                                        rows="4">{{ isset($kerjasama) ? $kerjasama->desc_kerjasama : '' }}</textarea>
                                </div>
                            </div>
                        </div>
