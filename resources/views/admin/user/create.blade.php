...
@section('title')
    <title>TI Poliwangi | Tambah User</title>
@endsection

@section('heading', 'Menambahkan Data Baru User')
                        ...
                        <div class="card-body">
                            <form action="{{ route('users.store') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="d-flex justify-content-between">
                                    <button type="submit" class="btn bg-yellow-theme fw-semi-bold">Simpan</button>
                                    <a href="{{ route('users.index') }}" type="button"
                                        class="btn btn-secondary fw-semi-bold"><i class='nav-icon fas fa-arrow-left'></i>
                                        &nbsp; Batal</a>
                                </div>
                            </form>
                        </div>
