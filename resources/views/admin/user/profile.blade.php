...
@section('title')
    <title>TI Poliwangi | Profile Page</title>
@endsection

@section('heading', 'Profile User')
                        ...
                        <div class="card-body box-profile">
                            <div class="text-center mb-3">
                                <img class="profile-user-img img-fluid img-circle admin_picture"
                                    src="{{ asset(Auth::user()->picture) }}" alt="User profile picture ">
                            </div>

                            <p class="profile-username text-center fw-medium">{{ Auth::user()->name }}</p>

                            <input type="file" name="gambar-profile" id="admin_image" style="opacity:0; display: none ">

                            <a href="javascript:void(0)" class="btn bg-yellow-theme btn-block fw-medium"
                                id="change_picture_btn">Ubah
                                Foto</a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                            ...
                            <form action="{{ route('profile.update') }}" enctype="multipart/form-data" method="post"
                                ...
                                <div class="form-group row">
                                    <div class="offset-sm-2 col-sm-10">
                                        <button type="submit" class="btn bg-yellow-theme fw-medium">Simpan</button>
                                    </div>
                                </div>
                            </form>
